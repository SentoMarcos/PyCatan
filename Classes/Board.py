...
class Board:
    ...
    def __init__(self, nodes=None, terrain=None):
        ...
        self.contacting_nodes = {
            ...
            8: [15, 14, 19, 25, 30, 29],
            9: [19, 18, 21, 29, 32, 31],
            10: [21, 20, 24, 31, 34, 33],
            11: [24, 23, 35, 33, 37, 36],
            12: [26, 25, 30, 40, 39, 38],
            13: [30, 29, 32, 38, 42, 41],
            14: [32, 31, 34, 41, 44, 43],
            15: [34, 33, 37, 43, 46, 45],
            16: [39, 38, 42, 49, 48, 47],
            17: [42, 41, 44, 47, 51, 50],
            18: [44, 43, 46, 50, 53, 52],
